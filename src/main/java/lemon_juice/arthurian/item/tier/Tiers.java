...
public class Tiers {
    ...
    public static final ForgeTier DURANDAL_TIER = new ForgeTier(4, 1841, 10.0F, 4.0F, 18, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.METEORIC_IRON_INGOT.get()));
