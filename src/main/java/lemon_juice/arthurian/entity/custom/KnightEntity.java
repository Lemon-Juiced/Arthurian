...
public class KnightEntity extends Monster implements GeoEntity {
    ...
    public KnightEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> tAnimationState) {
        if(tAnimationState.isMoving()) {
            tAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.knight.walk", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }

        tAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.knight.idle", Animation.LoopType.LOOP));
        return PlayState.CONTINUE;
    }
